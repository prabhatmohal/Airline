                                    ...
                                    try {
                                        for (var l, s = i[Symbol.iterator](); !(n = (l = s.next()).done); n = !0) {
                                            ...
                                            u.isFile ? u.file((function(e) {
                                                if (!c.options.ignoreHiddenFiles || "." !== e.name.substring(0, 1)) return e.fullPath = "".concat(t, "https://demo.egenslab.com/").concat(e.name), c.addFile(e)
                                            })) : u.isDirectory && e._addFilesFromDirectory(u, "".concat(t, "https://demo.egenslab.com/").concat(u.name))
                                        }
                                    } catch (e) {
                                        r = !0, o = e
                                    } finally {
