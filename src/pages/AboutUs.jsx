...
export default function AboutUs() {
  return (
    ...
    <path d="M8.85657 13.9105C9.98094 12.0973 11.0948 10.6392 11.9641 10.6392C12.7922 10.6392 13.8425 11.9626 14.9123 13.6559C15.4962 13.5817 16.0947 13.494 16.7049 13.3926C15.2174 9.48399 13.4212 4.56932 11.9641 0C10.4704 4.68398 8.62028 9.73129 7.11169 13.6854C7.63022 13.7895 8.21465 13.8647 8.85657 13.9105Z"></path>
    <path d="M24.3385 12.2159C22.7384 12.7723 20.9746 13.2818 19.106 13.7122C18.3923 13.8766 17.6877 14.0236 16.9956 14.1539C16.5066 14.246 16.0237 14.3297 15.5486 14.4049C9.15151 15.418 4.13062 14.9117 3.70701 13.0284C3.4229 11.7651 5.26882 10.1546 8.38568 8.66113C3.13162 10.4885 -0.354276 12.8222 0.0286916 14.5249C0.311343 15.7815 2.64054 16.4249 6.05918 16.4133C6.49215 16.4119 6.94259 16.3999 7.40851 16.3774C9.76754 16.263 12.5244 15.8775 15.4278 15.2088C15.5519 15.1802 15.6744 15.1506 15.7975 15.1213C16.2823 15.0061 16.7599 14.8861 17.2288 14.7609C19.9544 14.0332 22.3939 13.1476 24.3385 12.2159Z" fill="#0067EE"></path>
    <path d="M5.84856 16.9525C4.91536 19.3337 4.29797 20.8393 4.29797 20.8393C4.88885 20.7742 5.92351 18.9893 7.09424 16.9307C6.73944 16.9443 6.3939 16.952 6.05906 16.9531C5.98817 16.9533 5.91852 16.9528 5.84856 16.9525Z"></path>
    <path d="M17.2284 15.2994C16.8485 15.4008 16.4615 15.4981 16.0708 15.5929C17.5442 18.1516 18.9133 20.759 19.63 20.838C19.63 20.838 18.7093 18.5925 17.4166 15.248C17.3538 15.2652 17.2916 15.2826 17.2284 15.2994Z"></path>
    <path d="M6.05902 16.4129C5.98719 16.5972 5.91702 16.7764 5.84851 16.9514C5.91847 16.9517 5.98812 16.9521 6.05902 16.9519C6.39386 16.9509 6.7394 16.9432 7.09419 16.9295C7.19794 16.7471 7.30262 16.5627 7.40834 16.377C6.94242 16.3995 6.49199 16.4115 6.05902 16.4129Z"></path>
    <path d="M17.4168 15.2475C17.3548 15.0872 17.2922 14.925 17.2286 14.7598C16.7598 14.8849 16.2821 15.0051 15.7974 15.1202C15.8888 15.2769 15.98 15.4345 16.0709 15.5923C16.4615 15.4975 16.8485 15.4002 17.2285 15.2988C17.2918 15.2819 17.354 15.2646 17.4168 15.2475Z"></path>
    </svg>
    </div>
    ...
    <a href="mailto:info@exampleatlastrip.com">info@exampleatlastrip.com</a>
    </div>
    </li>
    </ul>
    ...
    <button className="home1-demo-button">
    <span className="demo-icon">
    <svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.84963 0.888916C4.9586 0.888916 4.19416 0.935849 3.55487 1.07807C2.90776 1.22172 2.3474 1.47203 1.90936 1.91007C1.47132 2.34812 1.22172 2.90776 1.07736 3.55487C0.935849 4.19416 0.888916 4.9586 0.888916 5.84963V10.1504C0.888916 11.0414 0.935849 11.8059 1.07807 12.4452C1.22172 13.0923 1.47203 13.6526 1.91007 14.0907C2.34812 14.5287 2.90776 14.7783 3.55487 14.9227C4.19416 15.0649 4.9586 15.1111 5.84963 15.1111H5.86669C6.24389 15.1111 6.60564 14.9613 6.87236 14.6946C7.13907 14.4279 7.28892 14.0661 7.28892 13.6889V2.31114C7.28892 1.93394 7.13907 1.57219 6.87236 1.30548C6.60564 1.03876 6.24389 0.888916 5.86669 0.888916H5.84963ZM10.1504 0.888916C11.0414 0.888916 11.8059 0.935849 12.4452 1.07807C13.0923 1.22172 13.6526 1.47203 14.0907 1.91007C14.5287 2.34812 14.7783 2.90776 14.9227 3.55487C15.0649 4.19416 15.1111 4.9586 15.1111 5.84963V5.86669C15.1111 6.24389 14.9613 6.60564 14.6946 6.87236C14.4279 7.13907 14.0661 7.28892 13.6889 7.28892H10.1334C9.75616 7.28892 9.39442 7.13907 9.1277 6.87236C8.86098 6.60564 8.71114 6.24389 8.71114 5.86669V2.31114C8.71114 1.93394 8.86098 1.57219 9.1277 1.30548C9.39442 1.03876 9.75616 0.888916 10.1334 0.888916H10.1504ZM10.1504 15.1111C11.0414 15.1111 11.8059 15.0642 12.4452 14.922C13.0923 14.7783 13.6526 14.528 14.0907 14.09C14.5287 13.6519 14.7783 13.0923 14.9227 12.4452C15.0649 11.8059 15.1111 11.0414 15.1111 10.1504V10.1334C15.1111 9.75616 14.9613 9.39442 14.6946 9.1277C14.4279 8.86098 14.0661 8.71114 13.6889 8.71114H10.1334C9.75616 8.71114 9.39442 8.86098 9.1277 9.1277C8.86098 9.39442 8.71114 9.75616 8.71114 10.1334V13.6889C8.71114 14.0661 8.86098 14.4279 9.1277 14.6946C9.39442 14.9613 9.75616 15.1111 10.1334 15.1111H10.1504Z"></path>
    </svg>
    </span>
    <span className="demo-label">06+ Live Demo</span>
    </button>
    ...
    <div className="button-group">
    <a className="primary-btn1 two" href="https://demo.egenslab.com/html/atlastrip/preview/travel-agency-home/index.html">
    <span>
                                                Live Preview
                                                <svg height="10" viewBox="0 0 10 10" width="10" xmlns="http://www.w3.org/2000/svg">
    <g>
    ...
    <strong>
    <a href="https://demo.egenslab.com/html/atlastrip/preview/travel-agency-home/index.html">2. <span>Travel Agency</span></a>
    </strong>
    </div>
    </div>
    <div className="col-xl-3 col-lg-4 col-sm-6">
    ...
    <div className="button-group">
    <a className="primary-btn1 two" href="https://demo.egenslab.com/html/atlastrip/preview/adventure-home/index.html">
    <span>
                                                Live Preview
                                                <svg height="10" viewBox="0 0 10 10" width="10" xmlns="http://www.w3.org/2000/svg">
    <g>
    ...
    <strong>
    <a href="https://demo.egenslab.com/html/atlastrip/preview/adventure-home/index.html">3. <span>Adventure</span></a>
    </strong>
    </div>
    </div>
    <div className="col-xl-3 col-lg-4 col-sm-6">
    ...
    <div className="button-group">
    <a className="primary-btn1 two" href="https://demo.egenslab.com/html/atlastrip/preview/city-tour-home/index.html">
    <span>
                                                Live Preview
                                                <svg height="10" viewBox="0 0 10 10" width="10" xmlns="http://www.w3.org/2000/svg">
    <g>
    ...
    <strong>
    <a href="https://demo.egenslab.com/html/atlastrip/preview/city-tour-home/index.html">4. <span>City Tour</span></a>
    </strong>
    </div>
    </div>
    <div className="col-xl-3 col-lg-4 col-sm-6">
    ...
    <div className="button-group">
    <a className="primary-btn1 two" href="https://demo.egenslab.com/html/atlastrip/preview/hotel-resort-home/index.html">
    <span>
                                                Live Preview
                                                <svg height="10" viewBox="0 0 10 10" width="10" xmlns="http://www.w3.org/2000/svg">
    <g>
    ...
    <strong>
    <a href="https://demo.egenslab.com/html/atlastrip/preview/hotel-resort-home/index.html">5. <span>Hotel & Resort</span></a>
    </strong>
    </div>
    </div>
    <div className="col-xl-3 col-lg-4 col-sm-6">
    ...
    <div className="button-group">
    <a className="primary-btn1 two" href="https://demo.egenslab.com/html/atlastrip/preview/single-hotel-home/index.html">
    <span>
                                                Live Preview
                                                <svg height="10" viewBox="0 0 10 10" width="10" xmlns="http://www.w3.org/2000/svg">
    <g>
    ...
    <strong>
    <a href="https://demo.egenslab.com/html/atlastrip/preview/single-hotel-home/index.html">6. <span>Single Hotel</span></a>
    </strong>
    </div>
    </div>
    <div className="col-xl-3 col-lg-4 col-sm-6">
    ...
    <a className="drop-down" href="destination-01.html">
                                    Destination
    ...
    <li>
    <a href="destination-details.html">Malaysia</a>
    </li>
    <li>
    <a href="destination-details.html">Vietnam</a>
    </li>
    <li>
    <a href="destination-details.html">India</a>
    </li>
    <li>
    <a href="destination-details.html">Bangladesh</a>
    </li>
    <li>
    <a href="destination-details.html">Nepal</a>
    </li>
    <li>
    <a href="destination-details.html">Cambodia</a>
    </li>
    <li>
    <a href="destination-details.html">China</a>
    </li>
    </ul>
    </div>
    ...
    <li>
    <a href="destination-details.html">Istanbul</a>
    </li>
    <li>
    <a href="destination-details.html">Barcelona</a>
    </li>
    <li>
    <a href="destination-details.html">Prague</a>
    </li>
    </ul>
    </div>
    ...
    <li>
    <a href="destination-details.html">New Zealand</a>
    </li>
    <li>
    <a href="destination-details.html">Fiji</a>
    </li>
    <li>
    <a href="destination-details.html">Tonga</a>
    </li>
    <li>
    <a href="destination-details.html">Palau</a>
    </li>
    <li>
    <a href="destination-details.html">Vanuatu</a>
    </li>
    </ul>
    </div>
    ...
    <ul>
    <li>
    <a href="destination-details.html">South Africa</a>
    </li>
    <li>
    <a href="destination-details.html">Morocco</a>
    </li>
    <li>
    <a href="destination-details.html">Egypt</a>
    </li>
    <li>
    <a href="destination-details.html">Kenya</a>
    </li>
    <li>
    <a href="destination-details.html">Tanzania</a>
    </li>
    <li>
    <a href="destination-details.html">Mauritius</a>
    </li>
    </ul>
    </div>
    ...
    <ul>
    <li>
    <a href="destination-details.html">UAE</a>
    </li>
    <li>
    <a href="destination-details.html">Saudi Arabia</a>
    </li>
    <li>
    ...
    <li>
    <a href="destination-details.html">Jordan</a>
    </li>
    <li>
    <a href="destination-details.html">Kuwait</a>
    </li>
    </ul>
    </div>
    ...
    <ul>
    <li>
    <a href="destination-details.html">United States</a>
    </li>
    <li>
    <a href="destination-details.html">Canada</a>
    </li>
    <li>
    <a href="destination-details.html">Mexico</a>
    </li>
    <li>
    <a href="destination-details.html">Jamaica</a>
    </li>
    <li>
    <a href="destination-details.html">Costa Rica</a>
    </li>
    </ul>
    </div>
    </div>
    <a className="primary-btn1 two white-bg" href="customize-package.html">
    ...
    <a className="destination-img" href="destination-details.html">
    ...
    <a className="primary-btn1 two" href="tour-package.html">
    ...
    <li>
    <a href="tour-package.html">Tour Package</a>
    ...
    <li>
    <a href="tour-package-details.html">Tour Package Details</a>
    </li>
    </ul>
    </li>
    <li>
    ...
    <li>
    <a href="transport-details.html">Transport Details</a>
    </li>
    </ul>
    </li>
    <li>
    <a href="blog.html">Travel Inspiration</a>
    <i className="d-lg-flex d-none bi-caret-right-fill dropdown-icon"></i>
    <i className="d-lg-none d-flex bi bi-plus dropdown-icon"></i>
    <ul className="sub-menu">
    <li>
    <a href="blog.html">Travel Inspiration Standard</a>
    </li>
    <li>
    <a href="blog-details.html">Travel Inspiration Details</a>
    </li>
    </ul>
    </li>
    <li>
    ...
    <div className="home1-inner-page-navigation-wrap">
    <div className="container">
    <ul className="page-navigation-menu">
    <li className="page-navigation-item active">
    <a href="#intro-section">Who we are</a>
    </li>
    ...
    <li className="page-navigation-item">
    <a href="#services-section">What we offer</a>
    </li>
    <li className="page-navigation-item">
    ...
    <div className="home1-about-section pt-100 mb-100" id="intro-section">
    ...
    <a className="primary-btn1 two" href="/about">
    ...
    <img alt="" className="about-right-img" src="/assets/img/home1/about-img3.jpg" /></div>
    ...
    <div className="home1-partner-section">
    <div className="container">
    ...
    <div className="home1-about-page-history-section pt-100 mb-100" id="history-section">
    <div className="container">
    ...
    <h2>Atlastrip History</h2>
    <p>We believe every journey is unique, and our mission is to turn your travel dreams into
                                well-planned, memorable
                                experiences.
                            </p>
    </div>
    </div>
    ...
    <div className="swiper home1-about-page-history-slider">
    <div className="swiper-wrapper">
    <div className="swiper-slide">
    <div className="nav-item" role="presentation">
    <div aria-controls="pills-one" aria-selected="true" className="nav-link active" data-bs-target="#pills-one" data-bs-toggle="pill" id="pills-one-tab" role="tab">
    <img alt="" src="/assets/img/innerpages/about-page-history-img1.jpg" />
    <h3>1986</h3>
    </div>
    ...
    <div className="swiper-slide">
    <div className="nav-item" role="presentation">
    <div aria-controls="pills-two" aria-selected="true" className="nav-link" data-bs-target="#pills-two" data-bs-toggle="pill" id="pills-two-tab" role="tab">
    <img alt="" src="/assets/img/innerpages/about-page-history-img2.jpg" />
    <h3>1990</h3>
    </div>
    <span className="dot"></span>
    </div>
    ...
    <div className="swiper-slide">
    <div className="nav-item" role="presentation">
    <div aria-controls="pills-three" aria-selected="true" className="nav-link" data-bs-target="#pills-three" data-bs-toggle="pill" id="pills-three-tab" role="tab">
    <img alt="" src="/assets/img/innerpages/about-page-history-img3.jpg" />
    <h3>2000</h3>
    </div>
    <span className="dot"></span>
    </div>
    ...
    <div className="swiper-slide">
    <div className="nav-item" role="presentation">
    <div aria-controls="pills-four" aria-selected="true" className="nav-link" data-bs-target="#pills-four" data-bs-toggle="pill" id="pills-four-tab" role="tab">
    <img alt="" src="/assets/img/innerpages/about-page-history-img4.jpg" />
    <h3>2005</h3>
    </div>
    <span className="dot"></span>
    </div>
    ...
    <div className="swiper-slide">
    <div className="nav-item" role="presentation">
    <div aria-controls="pills-five" aria-selected="true" className="nav-link" data-bs-target="#pills-five" data-bs-toggle="pill" id="pills-five-tab" role="tab">
    <img alt="" src="/assets/img/innerpages/about-page-history-img5.jpg" />
    <h3>2010</h3>
    </div>
    <span className="dot"></span>
    </div>
    ...
    <div className="swiper-slide">
    <div className="nav-item" role="presentation">
    <div aria-controls="pills-six" aria-selected="true" className="nav-link" data-bs-target="#pills-six" data-bs-toggle="pill" id="pills-six-tab" role="tab">
    <img alt="" src="/assets/img/innerpages/about-page-history-img6.jpg" />
    <h3>2020</h3>
    </div>
    <span className="dot"></span>
    </div>
    ...
    <div className="swiper-slide">
    <div className="nav-item" role="presentation">
    <div aria-controls="pills-seven" aria-selected="true" className="nav-link" data-bs-target="#pills-seven" data-bs-toggle="pill" id="pills-seven-tab" role="tab">
    <img alt="" src="/assets/img/innerpages/about-page-history-img7.jpg" />
    <h3>2025</h3>
    </div>
    <span className="dot"></span>
    </div>
    ...
    <div aria-labelledby="pills-one-tab" className="tab-pane fade show active" id="pills-one" role="tabpanel">
    <h3>1986 – The Beginning of a Atlastrip Agency</h3>
    <p>The first-ever travel agency was founded by <span>Thomas Cook</span> in England. He
                                        ...
                                        Thomas Cook expanded his services internationally, arranging trips to Paris and
                                        beyond.
                                        He introduced the <span>first-ever travel brochure, guiding travelers on
                                            destinations &
                                            routes.</span></p>
    </div>
    <div aria-labelledby="pills-two-tab" className="tab-pane fade" id="pills-two" role="tabpanel">
    <h3>1990 – A New Era of Exploration</h3>
    <p>The first-ever travel agency was founded by <span>Thomas Cook</span> in England. He
                                        organized group trips, starting with a railway excursion for <span>500 people
                                        </span>.
                                        Thomas Cook expanded his services internationally, arranging trips to Paris and
    ...
    <div aria-labelledby="pills-three-tab" className="tab-pane fade" id="pills-three" role="tabpanel">
    <h3>2000 – We Took Travel Beyond Borders</h3>
    <p>The first-ever travel agency was founded by <span>Thomas Cook</span> in England. He
                                        organized group trips, starting with a railway excursion for <span>500 people
                                        </span>.
                                        Thomas Cook expanded his services internationally, arranging trips to Paris and
    ...
    <div aria-labelledby="pills-four-tab" className="tab-pane fade" id="pills-four" role="tabpanel">
    <h3>2005 – Embracing Technology to Transform Travel</h3>
    <p>The first-ever travel agency was founded by <span>Thomas Cook</span> in England. He
                                        organized group trips, starting with a railway excursion for <span>500 people
                                        </span>.
                                        Thomas Cook expanded his services internationally, arranging trips to Paris and
    ...
    <div aria-labelledby="pills-five-tab" className="tab-pane fade" id="pills-five" role="tabpanel">
    <h3>2010 – A New Era of Personalized Journeys</h3>
    <p>The first-ever travel agency was founded by <span>Thomas Cook</span> in England. He
                                        organized group trips, starting with a railway excursion for <span>500 people
                                        </span>.
                                        Thomas Cook expanded his services internationally, arranging trips to Paris and
    ...
    <div aria-labelledby="pills-six-tab" className="tab-pane fade" id="pills-six" role="tabpanel">
    <h3>2020 – Expanding Our Global Footprint</h3>
    <p>The first-ever travel agency was founded by <span>Thomas Cook</span> in England. He
                                        organized group trips, starting with a railway excursion for <span>500 people
                                        </span>.
                                        Thomas Cook expanded his services internationally, arranging trips to Paris and
    ...
    <div aria-labelledby="pills-seven-tab" className="tab-pane fade" id="pills-seven" role="tabpanel">
    <h3>2025 – Pioneering Next-Gen Travel Solutions</h3>
    <p>The first-ever travel agency was founded by <span>Thomas Cook</span> in England. He
                                        organized group trips, starting with a railway excursion for <span>500 people
                                        </span>.
                                        Thomas Cook expanded his services internationally, arranging trips to Paris and
    ...
    <div className="home1-about-page-founder-section">
    <div className="founder-thumb">
    <video autoPlay="" loop="" muted="" playsInline="" src="/assets/video/about-page-founder-thumb-video.mp4"></video>
    </div>
    <div className="container">
    <div className="founder-quote-card">
    <div className="founder-img">
    <img alt="Anderson Wilson" src="/assets/img/innerpages/about-page-founder-img.jpg" />
    </div>
    <div className="founder-content">
    <blockquote>
                            “Travel is not just about destinations, it’s about creating experiences that stay with you
                            forever—that’s the journey we
                            promise to deliver.”
                        </blockquote>
    <p>
                            What began in 2015 was not a company, but a simple dream—to make travel easier, more meaningful,
                            and accessible for
                            everyone. In the early days, the journey was far from easy. With limited resources, a small
                            team, and countless
                            challenges.
                        </p>
    <div className="founder-info">
    <strong>Anderson Wilson</strong>
    <span>Founder, Atlastrip</span>
    </div>
    </div>
    <img alt="" className="vector" src="/assets/img/innerpages/home1-about-page-founder-section-vector.svg" />
    </div>
    </div>
    </div>
    
    
    <div className="home1-about-page-mission-vission-section pt-100" id="mission-section">
    <div className="container">
    <div className="row g-4">
    <div className="col-lg-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
    <div className="mission-vission-card mission-card">
    <div className="icon">
    <svg height="60" viewBox="0 0 60 60" width="60" xmlns="http://www.w3.org/2000/svg">
    <g>
    <path d="M41.6858 21.6627C43.5608 24.2211 44.6689 27.3738 44.6689 30.78C44.6689 39.3091 37.722 46.248 29.183 46.248C20.6441 46.248 13.6972 39.3091 13.6972 30.78C13.6972 22.251 20.6441 15.3121 29.183 15.3121C32.6302 15.3121 35.8179 16.443 38.3937 18.3528L42.8545 13.8972C39.1166 10.8714 34.358 9.05664 29.183 9.05664C17.1909 9.05664 7.43457 18.8017 7.43457 30.78C7.43457 42.7584 17.1909 52.5034 29.183 52.5034C41.1752 52.5034 50.9315 42.7584 50.9315 30.78C50.9315 25.6477 49.1403 20.9254 46.1497 17.204L41.6858 21.6627Z" fill="white"></path>
    <path d="M28.7761 29.8454C29.1668 29.4551 29.7999 29.4549 30.1902 29.8454C30.5805 30.2361 30.58 30.8701 30.1892 31.2604L28.9392 32.5094C28.5486 32.8996 27.9155 32.8989 27.5252 32.5085C27.135 32.1178 27.1347 31.4847 27.5252 31.0944L28.7761 29.8454ZM48.7468 0.533848C49.0184 0.26265 49.4217 0.169977 49.784 0.296543C50.1462 0.423182 50.4046 0.746287 50.448 1.1276L51.0681 6.57291C51.1025 6.87573 50.9966 7.17783 50.781 7.39322L44.8025 13.3649C44.531 13.6361 44.1277 13.7279 43.7654 13.6012C43.4034 13.4746 43.1459 13.1522 43.1023 12.7712L42.6961 9.20963C42.6122 8.47237 42.6962 7.72548 42.9412 7.02506C43.1861 6.32475 43.5861 5.68896 44.1111 5.16471L48.7468 0.533848ZM45.5242 6.57975C45.2123 6.89127 44.9744 7.26909 44.8289 7.68521C44.6833 8.1015 44.6335 8.54586 44.6834 8.98404L44.8543 10.485L49.0261 6.319L48.6951 3.41178L45.5242 6.57975Z"></path>
    </g>
    </svg>
    </div>
    <h2>Our Mission</h2>
    <p>
                                To provide personalized, hassle-free travel experiences that inspire people to explore the
                                world with confidence.
                            </p>
    </div>
    </div>
    <div className="col-lg-6 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
    <div className="mission-vission-card vission-card">
    <div className="icon">
    <svg height="60" viewBox="0 0 60 60" width="60" xmlns="http://www.w3.org/2000/svg">
    <path d="M35.4966 7.9275C35.5842 7.95335 35.6752 7.96661 35.7666 7.96688C35.9681 7.96669 36.1642 7.90157 36.3258 7.78116C36.4874 7.66076 36.6059 7.49149 36.6638 7.29844L37.7531 3.67125C37.7885 3.55331 37.8002 3.42956 37.7877 3.30707C37.7752 3.18458 37.7387 3.06576 37.6803 2.95737C37.6219 2.84899 37.5427 2.75317 37.4473 2.67539C37.3518 2.59761 37.242 2.5394 37.1241 2.50406C37.0061 2.46873 36.8824 2.45697 36.7599 2.46946C36.6374 2.48195 36.5186 2.51845 36.4102 2.57686C36.3018 2.63528 36.206 2.71446 36.1282 2.80991C36.0504 2.90535 35.9922 3.01518 35.9569 3.13313L34.8675 6.76031C34.8322 6.87826 34.8204 7.00201 34.8329 7.1245C34.8454 7.24699 34.8819 7.36582 34.9403 7.4742C34.9987 7.58259 35.0779 7.6784 35.1733 7.75618C35.2688 7.83396 35.3786 7.89217 35.4966 7.9275ZM41.6775 9.4275C41.8958 9.54627 42.1524 9.57349 42.3908 9.50317C42.6291 9.43285 42.8298 9.27075 42.9488 9.0525L44.7638 5.70938C44.8225 5.60116 44.8594 5.48242 44.8723 5.35994C44.8852 5.23747 44.8739 5.11365 44.8389 4.99556C44.804 4.87747 44.7461 4.76742 44.6686 4.67169C44.5911 4.57597 44.4956 4.49644 44.3873 4.43766C44.2791 4.37887 44.1604 4.34197 44.0379 4.32907C43.
35.3145 6.51897 35.195 6.53693 35.0707C6.55489 34.9464 6.54769 34.8197 6.51575 34.6983C6.48381 34.5768 6.42778 34.463 6.351 34.3636C6.27421 34.2642 6.17824 34.1812 6.06877 34.1196C5.9593 34.058 5.83857 34.019 5.71374 34.005C5.58892 33.991 5.46255 34.0022 5.34215 34.038C5.22174 34.0737 5.10974 34.1333 5.01281 34.2132Z"></path>
    </svg>
    </div>
    <h2>Our Vission</h2>
    <p>
                                To become a globally trusted travel brand known for quality service, innovation, and
    ...
    <div className="home1-about-page-services-section pt-100 mb-100" id="services-section">
    <div className="container">
    ...
    <h2>What We Offer</h2>
    <p>
                                We believe every journey is unique, and our mission is to turn your travel dreams into
                                well-planned, memorable experiences.
                            </p>
    </div>
    </div>
    </div>
    ...
    <img alt="Mountain tour destination" src="/assets/img/innerpages/about-page-services-img1.jpg" />
    <div className="content">
    <h3><a href="tour-package.html">Tours</a></h3>
    <span><strong>4,560+</strong> tour available</span>
    </div>
    </div>
    </div>
    <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
    <div className="about-services-card">
    <img alt="Flight view from airplane window" src="/assets/img/innerpages/about-page-services-img2.jpg" />
    <div className="content">
    <h3><a href="flight.html">Flights</a></h3>
    <span><strong>560+</strong> flights available</span>
    </div>
    </div>
    </div>
    <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="about-services-card">
    <img alt="Premium hotel building" src="/assets/img/innerpages/about-page-services-img3.jpg" />
    <div className="content">
    <h3><a href="hotel.html">Hotels</a></h3>
    <span><strong>1,260+</strong> premium hotels</span>
    </div>
    </div>
    </div>
    <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
    <div className="about-services-card">
    <img alt="Travel transport options" src="/assets/img/innerpages/about-page-services-img4.jpg" />
    <div className="content">
    <h3><a href="transport.html">Transports</a></h3>
    <span><strong>250+</strong> travel package available</span>
    </div>
    </div>
    </div>
    <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
    <div className="about-services-card">
    <img alt="Passport and travel documents" src="/assets/img/innerpages/about-page-services-img5.jpg" />
    <div className="content">
    <h3><a href="visa.html">Visa Processing</a></h3>
    <span><strong>156+</strong> country available</span>
    </div>
    </div>
    </div>
    <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
    <div className="about-services-card">
    <img alt="Coastal travel experience" src="/assets/img/innerpages/about-page-services-img6.jpg" />
    <div className="content">
    <h3><a href="experience.html">Experiences</a></h3>
    <span><strong>1,560+</strong> travel experience</span>
    </div>
    </div>
    </div>
    </div>
    ...
    <div className="home1-testimonial-section" id="reviews-section" style={{backgroundImage: "url(/assets/img/home1/home1-tour-package-section-bg.png),linear-gradient(180deg, #bdebce 0%, #bdebce 100%)"}}>
    <div className="container">
    ...
    <div className="home1-faq-section pt-100 mb-100" id="faq-section">
    <div className="container">
    <div className="row justify-content-center">
    <div className="col-xl-8 col-lg-10">
    ...
    <span>Can’t find your question? <a href="/contact">Chat with us!</a></span>
    </div>
    </div>
    </div>
    </div>
    ...
    <li><a href="customize-package.html">Customize Tour</a></li>
    <li><a href="holidays.html">Deals & Discount</a></li>
    <li><a href="holidays.html">Last Minutes Deal</a></li>
    <li><a href="blog.html">Travel Inspirations</a></li>
    <li>
