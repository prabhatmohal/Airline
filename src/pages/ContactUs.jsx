...
export default function ContactUs() {
  return (
    ...
    <form>
    <div className="contact-form-top mb-60">
    <h3>I’m Interested with in...</h3>
    <div aria-label="Basic checkbox toggle button group" className="btn-group" role="group">
    <input className="btn-check" id="btncheck1" type="checkbox" />
    <label className="btn" htmlFor="btncheck1">Visa Processing</label>
    <input className="btn-check" id="btncheck2" type="checkbox" />
    <label className="btn" htmlFor="btncheck2">Flight Booking</label>
    <input className="btn-check" id="btncheck3" type="checkbox" />
    <label className="btn" htmlFor="btncheck3">Hotel Reservation</label>
    <input className="btn-check" id="btncheck4" type="checkbox" />
    <label className="btn" htmlFor="btncheck4">Tour Booking</label>
    <input className="btn-check" id="btncheck5" type="checkbox" />
    <label className="btn" htmlFor="btncheck5">Custom Package</label>
    <input className="btn-check" id="btncheck6" type="checkbox" />
    <label className="btn" htmlFor="btncheck6">Car Rent</label>
    <input className="btn-check" id="btncheck7" type="checkbox" />
    <label className="btn" htmlFor="btncheck7">Boat & Crusies</label>
    </div>
    </div>
